...
BOT_TOKEN = environ.get('BOT_TOKEN', '6881297643:AAESYiaV6V4Xwd0ZaUC1SZbgM4SodFogPTQ')
#---------------------------------------------------------------
#---------------------------------------------------------------
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002090559987')) # 
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("FQDN", "agricultural-alexina-supercrazy786766-5439f943.koyeb.app/")
